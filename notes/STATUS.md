...
## ⚠️ Открытый вопрос — версионирование
`projects/uzmrc` **в .gitignore** корневого репо, своего git нет → код этой сессии нигде не зафиксирован. Происхождение `rag-cms` (наша/чужая основа) не выяснено → не пушил без решения. **Нужно решить:** отдельный приватный репо для uzmrc? Где?
...
1. **Решить версионирование** (см. ⚠️ выше) — зафиксировать код этой сессии.
