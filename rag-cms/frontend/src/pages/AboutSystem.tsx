          ...
          {stats && (
            <>
              ...
              <p className="muted" style={{ marginTop: 16, fontSize: 13 }}>
                Источник корпуса — публичные документы УзКРИ (uzmrc.uz): нормативные акты,
                финансовая и квартальная отчётность, обзоры рынка ипотеки, материалы по
                ипотечной грамотности, экспертные статьи, эмиссии и существенные факты
                (PDF + страницы сайта, узб./рус./англ.).
              </p>
            </>
          )}
        </div>
