...
_SINGLE_PASS_RULES = (
    ...
    "- If the evidence PARTIALLY relates to the question but doesn't cover the exact\n"
    "  detail asked, summarize what IS actually covered (with citations) and clearly\n"
    "  say which specific part isn't addressed — do not blanket-refuse just because\n"
    "  no single chunk is a perfect match; related, on-topic material is still useful.\n"
    "- Only when the evidence is genuinely unrelated to the question, say so plainly\n"
    "  and set a low confidence — do NOT fabricate to fill the gap.\n"
